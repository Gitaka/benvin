                   ...
                   <div id="posts-img">
                     <?php
                        ...
                        ?>
                            ...
                            @endfor
        <img src="{{asset($post->imgPath).'/'.$images[0]}}" class="img-rounded" width="230" height="150"/> 
                   </div>
                   <div id="posts-details">
                      <div id="posts-title">
                         <h3><a href="{{url('staff/viewpost')}}/{{$post->id}}">{{$post->title}}</a></h3>
                      </div> 
                      <div id="posts-desc">
                         {{substr($post->post,0,150)}}-<a href="{{url('staff/viewpost')}}/{{$post->id}}">ReadMore</a>
                      </div>   
