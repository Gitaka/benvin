...
<script type="text/javascript">
   ...
   var BASE_URL = getBaseUrl();
    ...
    setInterval(function(){
      ...
      $("#public-chat-box").load(BASE_URL + "staff/getbroadcast");
          },1000);
      $("#public-chat-box").load(BASE_URL + "staff/getbroadcast")
  ...
  $('#public-sendMessage').click(function(){
    ...
    setInterval(function(){
      //refresh every 10 seconds
      $("#chatMessages").load(BASE_URL + "staff/getchat" + "?" + "receiverId"+"="+receiverId+"&"+"senderId"+"="+senderId);
          },1000);
