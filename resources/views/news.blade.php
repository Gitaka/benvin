...
<div id="news" class="row">
          <div id="posts"class="row">
            ...
            @foreach(array_chunk($posts->all(),3) as $row)
                    ...
                    @foreach($row as $post)
                  <div id="posts-info" class="col-sm-4">
                   <div id="posts-img">
                     <?php
                             $path=$post->imgPath;
                        ...
                        ?>
                            ...
                            @endfor
        <img src="{{asset($post->imgPath).'/'.$images[0]}}" class="img-rounded" width="280" height="150"/> 
                   </div>
                   <div id="posts-details">
                      <div id="posts-title">
                         <h3><a href="{{url('/viewnews')}}/{{$post->id}}" style="color:#187BBD">{{$post->title}}</a></h3>
                      </div> 
                      <div id="posts-desc">
                         {{substr($post->post,0,150)}}-<a href="{{url('/viewnews')}}/{{$post->id}}" style="color:#187BBD">ReadMore</a>
                      </div>   
                      <div id="post-share" class="col-sm-12">
                        <div class="col-sm-6">
                           ...
                           <div class="col-sm-6">
                               ...
                               <label style="color:#0099FF;font-weight:normal">Like</label>
                        </div>
                      </div>              
                   </div>
                     </div>
