...
<h2>Messages
<small>From Benvin Solutions.</small>
</h2>
<div class="col-sm-12" id="client-user-messages">
  @foreach($messages as $message)
  <div id="ucm" class="col-sm-12">
   <div id="user-message" class="col-sm-6">
     {{$message->message}}
  </div>
  <div id="date-sent"class="col-sm-2">
   ...
   <div class="col-sm-2">
     <div class="checkbox">
       <label><input type="checkbox" value="">Mark As Read</label>
    </div>
  </div>
  <div class="col-sm-2">
     <button class="btn btn-danger"><i class="fa fa-trash fa-fw"></i>Delete</button>
  </div>
