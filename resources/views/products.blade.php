            ...
            @foreach(array_chunk($products->all(),3) as $row)
		            ...
		            @foreach($row as $product)
                      <div id="product-info" class="col-sm-4">
				       <div id="product-img">
	                    <a href="{{url('cat-products')}}/{{$product->id}}"><img class="img-rounded"src="{{asset($product->categoryImg)}}" width="280" height="250"></a>
				       </div>
				       <div id="product-details">
	                      <div id="product-name">
	                         <a href="{{url('cat-products')}}/{{$product->id}}" style="color:#000"><h4>{{$product->name}}</h4></a>
	                      </div>
