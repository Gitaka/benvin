        ...
        <div id="page-wrapper">
           <h1>Accounts Receivable</h1>
             <div class="row" id="payable-nav-buttons">
              <div id="sales-btn"class="col-sm-2"><button class="btn btn-default"><a href="{{url('receivable-sales')}}">Sales</a></button></div>
              <div id="capital-btn"class="col-sm-2"><button class="btn btn-default">
               <a href="{{url('receivable-capital')}}">Capital</a>
              </button></div>
              <div id="liability-btn"class="col-sm-2"><button class="btn btn-default">
               <a href="{{url('receivable-liability')}}">Liability</a>
              </button></div>
              <div id="assets-btn"class="col-sm-2"><button class="btn btn-default">
               <a href="{{url('receivable-assets')}}">Assets</a>
              </button></div>
             </div>
         <div class="row">
          @yield('receivable')
