    ...
    <div id="wrapper">
        ...
        <h2>Credit Asset
                ...
                <button class="btn btn-sm btn-default">
                   <a href="{{url('gen/C_assestsExcel')}}">Gen Excel</a>
                 </button>
        </h2>
        <!--<button style="display:none;"class="btn btn-info btn-block" id="credit-form-btn">Hide Create Asset Form</button>   
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('creditassetentry') }}">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label">TrackingNo</label>
                                ...
                                <input type="text" placeholder="confirmationCode"id="code"class="form-control" name="confirm" value="{{ old('confirm') }}"></br>
                                
                                <textarea cols="50"placeholder="Description" rows="10" id="desc"class="form-control" name="description"></textarea></br>

                                <input type="text"placeholder="Receiver" id="receiver"class="form-control" name="receiver" value="{{ old('receiver') }}"></br>

                                <input type="text"placeholder="Email" id="email"class="form-control" name="email" value="{{ old('email') }}"></br>
                                <input type="text"placeholder="phone" id="phone"class="form-control" name="phone" value="{{ old('phone') }}"></br>
...
<button class="btn btn-info btn-block" id="view-credit-btn">Create Credit Asset Entry</button>-->
          <div id="view-credit" class="row">
           <div id="view-credit-header"class="col-sm-12">
             <div class="col-sm-2">Receiver</div>
           ...
           @foreach($creditassets as $creditasset)
           <div id="view-credit-details" class="col-sm-12">
              <div class="col-sm-2">{{$creditasset->receiver}}</div>
              <div class="col-sm-2">{{$creditasset->trackingNo}}</div>
              <div class="col-sm-2">{{$creditasset->type}}</div>
              <div class="col-sm-3">{{$creditasset->description}}</div>
              <div class="col-sm-2"><button class="btn btn-info btn-sm">KSH{{$creditasset->amount}}</button></div>
            <div class="col-sm-1"><button class="btn btn-warning btn-sm">KSH{{$creditasset->balance}}</button></div>
           </div>
           @endforeach
             <?php echo $creditassets->render()?>
         </div>
        </div>
        <!-- /#page-wrapper -->
