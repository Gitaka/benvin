...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
         <div class="row">
            <h2>Reports</h2>
            <div id="show-report" class="col-sm-12">
                @foreach($report as $report)
                  <div id="show-report-subject">
                    {{$report->subject}}
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <button class="btn btn-danger btn-sm">
                         <a href="{{url('deletereport')}}/{{$report->id}}" style="color:#fff;">Delete</a>
                       </button>
                 </div>
                  <div id="show-report-summary">
                    {{$report->summary}}
                  </div>
                  <div id="show-report-files">
                      <?php
                    $path = $report->report;
