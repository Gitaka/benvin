...
<!-- /.navbar --> 
      ...
      @endforeach
            ...
            @foreach(array_chunk($products->all(),3) as $row)
                  ...
                  <div id="product-info" class="col-sm-4">
                     <div id="product-img">
                            <img class="img-rounded"src="{{asset($product->productImg)}}" width="280" height="200">
                     </div>
                     ...
                     <div id="cart-details">
                             ...
                             <div class="col-sm-6">
                             <label id="label-cart-style" data-toggle="modal" data-target="#myModal">ADD TO CART</label>
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">
                       <button id="singin"class="btn btn-info">Log In</button>
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
